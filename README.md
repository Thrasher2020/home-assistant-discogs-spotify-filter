...
- optionally cross-references a **secondary calendar** (e.g. your iCloud/Google calendar) so gigs you've already booked are hidden;
...
| **Secondary calendar** *(optional)* | Only needed to hide already-booked gigs | any HA calendar entity |
...
| Secondary calendar | Calendar to cross-reference; matching gigs are treated as already booked and hidden |
...
- **`in_calendar` hidden gigs** — a gig is hidden when any candidate band name loosely matches a same-day event on your secondary calendar.
